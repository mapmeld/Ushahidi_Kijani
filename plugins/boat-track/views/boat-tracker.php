...
<div style="background-color:#a0a0a0;padding:10px;">
	...
	<input type='button' id='pop-estimator' value=' Add Boat Tracking ' onclick="applyScripts()"/>
</div>

<script type="text/javascript">
/* Live boat tracking from MarineTraffic.com for Ushahidi and CrowdMap
...
var ships=[
	...
	{id:369517000,
		name:"Jason K McCall",
		size:"44 m X 9 m",
		photo:"http://mapmeld.appspot.com/jason_k_mccall.jpg",
		callsign:"WDA4730"},
	{id:576813000,
		name:"Express",
		size:"159m x 31m",
